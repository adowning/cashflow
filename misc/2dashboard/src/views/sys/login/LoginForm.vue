<template>
  <div class="flex flex-col mt-6">
    ...
    <Form class="p-4 enter-x" :model="formData" :hideRequiredMark="true" :rules="getFormRules" ref="formRef"
      layout="vertical" v-show="getShow" @keypress.enter="handleLogin">
...
import { getCurrentUser, signIn } from '/@/client/auth';
