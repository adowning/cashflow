...
// // export const systemEnum = pgEnum('SystemEnum', [
// //   'player',
// //   'shop',
// //   'bank',
// //   'jpg',
...
// export const loyaltyFundTransactionTypeEnum = pgEnum('LoyaltyFundTransactionType', [
//   'CONTRIBUTION',
//   'PAYOUT',
// ]);

// // export const gameProviderNameEnum = pgEnum('GameProviderName', [
// //   'pragmaticplay',
// //   'evoplay',
// //   'netent',
// //   'playngo',
...
// export const gameCategoriesEnum = pgEnum('game_categories', ['SLOTS', 'FISH', 'TABLE']);
...
//     .$defaultFn(() => createId())
//     .primaryKey(),
//   userId: text('user_id').unique().notNull(), // New: Links to users.id and ensures uniqueness
...
//   // phpId: integer('phpId').default(0).notNull(),
...
//   // lastSeen: timestamp('last_seen', { mode: 'date', precision: 3 }),
//   rtgBlockTime: integer('rtg_block_time').default(0).notNull(),
//   // phone: text('phone'),
//   // path: text('path').array().default([]).notNull(),
//   // invitorId: text('invitor_id'),
//   avatar: text('avatar').default('avatar-01.webp').notNull(),
//   status: statusEnum('status').default('ACTIVE').notNull(),

//   address: integer('address').default(0).notNull(),
...
// export const vipInfos = pgTable('vip_info', {
//   id: text('id')
//     .$defaultFn(() => createId())
//     .primaryKey(),
...
//   rtp: integer('rtp').default(0).notNull(),
//   duration: integer('duration').default(0).notNull(),
//   endAt: timestamp('end_at', { mode: 'date', precision: 3 }),
//   startingBalance: integer('starting_balance').default(0).notNull(),
//   expiredTime: timestamp('expired_time', { mode: 'date', precision: 3 }),
//   createdAt: timestamp('created_at', { mode: 'date', precision: 3 }).defaultNow().notNull(),
//   updatedAt: timestamp('updated_at', { mode: 'date', precision: 3 }).defaultNow().notNull(),
// });
...
//   percent: integer('percent').default(1).notNull(),
//   paySum: integer('paySum').default(5).notNull(),
//   startBalance: integer('startBalance').default(0).notNull(),
...
// export const operatorSwitchHistories = pgTable('operator_switch_history', {
//   id: text('id')
//     .$defaultFn(() => createId())
//     .primaryKey(),
//   playerId: text('player_id').notNull(),
...
//   switchedAt: timestamp('switched_at', { mode: 'date', precision: 3 }).defaultNow().notNull(),
//   createdAt: timestamp('created_at', { mode: 'date', precision: 3 }).defaultNow().notNull(),
//   updatedAt: timestamp('updated_at', { mode: 'date', precision: 3 }).defaultNow().notNull(),
// });
...
//   withdrawable: integer('withdrawable').default(0).notNull(),
//   pending: integer('pending').default(0).notNull(),
//   lastUpdateTransactionId: text('last_update_transaction_id'),
//   updatedAt: timestamp('updated_at', { mode: 'date', precision: 3 }).defaultNow().notNull(),
...
//   icon: text('icon').default('/images/vip/rank1.avif').notNull(),
...
// export const vipCashbacks = pgTable('vip_cashback', {
//   id: text('id')
//     .$defaultFn(() => createId())
//     .primaryKey(),
//   playerId: text('player_id'),
...
// export const vipLevelUpBonuses = pgTable('vip_level_up_bonus', {
//   id: text('id')
//     .$defaultFn(() => createId())
//     .primaryKey(),
//   playerId: text('player_id').notNull(),
...
// // export const affiliates = pgTable('affiliates', { id: text('id').$defaultFn(() => createId()).primaryKey(), playername: text('playername').notNull(), firstName: text('first_name').notNull(), lastName: text('last_name').notNull(), status: text('status').notNull(), email: text('email').notNull(), role: text('role').notNull(), referralCode: text('referral_code').notNull(), parentId: text('parent_id'), path: text('path').array().default([]).notNull(), password: text('password').notNull(), createdAt: timestamp('created_at', { mode: 'date', precision: 3 }).defaultNow().notNull(), updatedAt: timestamp('updated_at', { mode: 'date', precision: 3 }).defaultNow().notNull() });
...
//     .$defaultFn(() => createId())
//     .primaryKey(),
//   name: text('name').default('setting').notNull(),
...
//   rates: text('rates').default('[{"USD": 1}]').notNull(),
...
//   isHorizontal: boolean('isHorizontal').default(false).notNull(),
//   jpgId: text('jpg_id'),
//   label: text('label'),
...
//     .$defaultFn(() => createId())
//     .primaryKey(),
//   master: doublePrecision('master').default(30).notNull(),
//   affiliate: doublePrecision('affiliate').default(20).notNull(),
...
//     .primaryKey(),
//   operatorId: text('operator_id').notNull(),
//   weekStartDate: timestamp('week_start_date', { mode: 'date', precision: 3 }).notNull(),
//   weekEndDate: timestamp('week_end_date', { mode: 'date', precision: 3 }).notNull(),
...
//     .$defaultFn(() => createId())
//     .primaryKey(),
//   type: loyaltyFundTransactionTypeEnum('type').notNull(),
...
//   expireDate: timestamp('expire_date', { mode: 'date', precision: 3 }).notNull(),
...
// export const progresses = pgTable('progres', {
//   id: text('id')
//     .$defaultFn(() => createId())
//     .primaryKey(),
...
// export const playersRelations = relations(players, (helpers) => ({
//   deposits: helpers.many(deposits, { relationName: 'DepositToPlayer' }),
//   gameSessions: helpers.many(gameSessions, { relationName: 'GameSessionsToPlayer' }),
//   jackpotWins: helpers.many(jackpotWins, { relationName: 'JackpotWinsToPlayer' }),
//   Jackpots: helpers.many(jackpots, { relationName: 'JackpotsToPlayer' }),
//   loyaltyFundTransactions: helpers.many(loyaltyFundTransactions, {
//     relationName: 'LoyaltyFundTransactionToPlayer',
//   }),
//   wallets: helpers.many(wallets, { relationName: 'PlayerWallets' }),
//   vipInfo: helpers.one(vipInfos),
//   withdrawals: helpers.many(withdrawals, { relationName: 'PlayerToWithdrawal' }),
//   ops: helpers.one(operators, {
//     relationName: 'OperatorsToPlayer',
//     fields: [players.activeOperatorId],
//     references: [operators.id],
//   }),
//   operatorSwitchHistory: helpers.many(operatorSwitchHistories, {
//     relationName: 'OperatorSwitchHistoryToPlayer',
//   }),
//   vipCashbacks: helpers.many(vipCashbacks, { relationName: 'PlayerToVipCashback' }),
//   vipLevelUpBonuses: helpers.many(vipLevelUpBonuses, { relationName: 'PlayerToVipLevelUpBonus' }),
//   vipSpinRewards: helpers.many(vipSpinRewards, { relationName: 'PlayerToVipSpinReward' }),
//   affiliateLogsInvited: helpers.many(affiliateLogs, { relationName: 'Invitor' }),
//   affiliateLogsReferred: helpers.many(affiliateLogs, { relationName: 'Child' }),
//   referralCodes: helpers.many(referralCodes, { relationName: 'PlayerToReferralCode' }),
//   PlayerBonus: helpers.many(playerBonuses, { relationName: 'PlayerToPlayerBonus' }),
// }));

// export const depositsRelations = relations(deposits, (helpers) => ({
//   players: helpers.one(players, {
...
// export const gameSessionsRelations = relations(gameSessions, (helpers) => ({
//   players: helpers.one(players, {
//     relationName: 'GameSessionsToPlayer',
//     fields: [gameSessions.playerId],
//     references: [players.id],
//   }),
//   game: helpers.one(games, {
...
// export const jackpotContributionsRelations = relations(jackpotContributions, (helpers) => ({
//   jackpots: helpers.one(jackpots, {
...
// export const jackpotWinsRelations = relations(jackpotWins, (helpers) => ({
//   jackpots: helpers.one(jackpots, {
//     relationName: 'JackpotWinsToJackpots',
//     fields: [jackpotWins.jackpotId],
//     references: [jackpots.id],
//   }),
//   player: helpers.one(players, {
...
//   jackpotContributions: helpers.many(jackpotContributions, {
//     relationName: 'JackpotContributionsToJackpots',
//   }),
//   jackpotWins: helpers.many(jackpotWins, { relationName: 'JackpotWinsToJackpots' }),
//   players: helpers.one(players, {
...
// export const operatorsRelations = relations(operators, (helpers) => ({
//   games: helpers.many(games, { relationName: 'GamesToOperators' }),
//   products: helpers.many(products, { relationName: 'OperatorsToProducts' }),
//   players: helpers.many(players, { relationName: 'OperatorsToPlayer' }),
//   settlements: helpers.many(operatorSettlements, { relationName: 'OperatorSettlementToOperators' }),
//   loyaltyFundContributions: helpers.many(loyaltyFundTransactions, {
//     relationName: 'LoyaltyFundTransactionToOperators',
//   }),
//   switchedFromHistory: helpers.many(operatorSwitchHistories, { relationName: 'SwitchedFrom' }),
//   switchedToHistory: helpers.many(operatorSwitchHistories, { relationName: 'SwitchedTo' }),
//   wallets: helpers.many(wallets, { relationName: 'OperatorsToWallet' }),
// }));

// export const operatorSwitchHistoriesRelations = relations(operatorSwitchHistories, (helpers) => ({
//   player: helpers.one(players, {
//     relationName: 'OperatorSwitchHistoryToPlayer',
//     fields: [operatorSwitchHistories.playerId],
//     references: [players.id],
//   }),
//   fromOperator: helpers.one(operators, {
//     relationName: 'SwitchedFrom',
//     fields: [operatorSwitchHistories.fromOperatorId],
//     references: [operators.id],
//   }),
//   toOperator: helpers.one(operators, {
...
// export const referralCodesRelations = relations(referralCodes, (helpers) => ({
//   player: helpers.one(players, {
//     relationName: 'PlayerToReferralCode',
//     fields: [referralCodes.playerId],
//     references: [players.id],
//   }),
// }));

// export const walletsRelations = relations(wallets, (helpers) => ({
//   operator: helpers.one(operators, {
//     relationName: 'OperatorsToWallet',
//     fields: [wallets.operatorId],
//     references: [operators.id],
//   }),
//   transactions: helpers.many(transactions, { relationName: 'TransactionToWallet' }),
//   balances: helpers.many(balances, { relationName: 'WalletBalances' }),
//   activeForPlayer: helpers.one(players, {
//     relationName: 'PlayerWallets',
//     fields: [wallets.playerId],
//     references: [players.id],
//   }),
// }));

// export const withdrawalsRelations = relations(withdrawals, (helpers) => ({
//   players: helpers.one(players, {
...
// export const vipRanksRelations = relations(vipRanks, (helpers) => ({
//   vipInfo: helpers.many(vipInfos, { relationName: 'VipInfoToVipRank' }),
//   levels: helpers.many(vipLevels, { relationName: 'VipLevelToVipRank' }),
// }));

// export const vipInfosRelations = relations(vipInfos, (helpers) => ({
//   vipRank: helpers.one(vipRanks, {
//     relationName: 'VipInfoToVipRank',
//     fields: [vipInfos.currentRankid],
//     references: [vipRanks.id],
//   }),
//   players: helpers.one(players, {
//     relationName: 'PlayerToVipInfo',
//     fields: [vipInfos.playerId],
//     references: [players.id],
//   }),
// }));

// export const vipLevelsRelations = relations(vipLevels, (helpers) => ({
//   parent: helpers.one(vipRanks, {
//     relationName: 'VipLevelToVipRank',
//     fields: [vipLevels.parentId],
//     references: [vipRanks.id],
//   }),
//   setting: helpers.one(settings, {
//     relationName: 'SettingToVipLevel',
//     fields: [vipLevels.settingId],
//     references: [settings.id],
//   }),
// }));

// export const vipCashbacksRelations = relations(vipCashbacks, (helpers) => ({
//   player: helpers.one(players, {
...
// export const vipLevelUpBonusesRelations = relations(vipLevelUpBonuses, (helpers) => ({
//   player: helpers.one(players, {
...
// export const vipSpinRewardsRelations = relations(vipSpinRewards, (helpers) => ({
//   player: helpers.one(players, {
...
// export const affiliateLogsRelations = relations(affiliateLogs, (helpers) => ({
//   invitor: helpers.one(players, {
//     relationName: 'Invitor',
//     fields: [affiliateLogs.invitorId],
//     references: [players.id],
//   }),
//   child: helpers.one(players, {
//     relationName: 'Child',
...
//   commission: helpers.one(commissions),
//   vipLevels: helpers.many(vipLevels, { relationName: 'SettingToVipLevel' }),
// }));

// export const gamesRelations = relations(games, (helpers) => ({
//   operators: helpers.one(operators, {
//     relationName: 'GamesToOperators',
//     fields: [games.operatorId],
//     references: [operators.id],
//   }),
//   gameSessions: helpers.many(gameSessions, { relationName: 'GameSessionsToGames' }),
// }));

// export const commissionsRelations = relations(commissions, (helpers) => ({
//   setting: helpers.one(settings, {
...
// export const operatorSettlementsRelations = relations(operatorSettlements, (helpers) => ({
//   operator: helpers.one(operators, {
...
// export const loyaltyFundTransactionsRelations = relations(loyaltyFundTransactions, (helpers) => ({
//   operator: helpers.one(operators, {
//     relationName: 'LoyaltyFundTransactionToOperators',
...
// export const balancesRelations = relations(balances, (helpers) => ({
//   wallet: helpers.one(wallets, {
...
// export const playerBonusesRelations = relations(playerBonuses, (helpers) => ({
//   player: helpers.one(players, {
//     relationName: 'PlayerToPlayerBonus',
//     fields: [playerBonuses.playerId],
//     references: [players.id],
//   }),
//   bonus: helpers.one(bonuses, {
...
// export const bonusesRelations = relations(bonuses, (helpers) => ({
//   playerBonuses: helpers.many(playerBonuses, { relationName: 'BonusToPlayerBonus' }),
// }));
