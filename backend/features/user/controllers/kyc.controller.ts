...
export const getCurrencies = catchAsync(async (_req: AuthRequest, res: Response) => {
  const currencies = await currencyService.getCurrencies();
  return res.send(currencies);
});

export const getEnableCurrencies = catchAsync(async (_req: AuthRequest, res: Response) => {
