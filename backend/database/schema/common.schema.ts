...
// Updated to include default CUID generation and $onUpdate timestamp
export const baseColumns = {
  ...
  updatedAt: timestamp("updated_at", { mode: "date", precision: 3 })
    .defaultNow()
    .notNull()
    .$onUpdate(() => sql`now()`), // Added auto-update
...
// This specific 'id' export is now redundant if using baseColumns,
// but can be kept if some tables need *only* this ID.
